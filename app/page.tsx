...
export default function Home() {
  return <main>
    ...
    <section className="chauffeur section wrap"><div className="driver-photo" aria-label="Peugeot 508 SW au crépuscule" /><div className="driver-copy"><p className="eyebrow ink">Votre chauffeur</p><h2>Une exigence simple : que votre trajet se déroule parfaitement.</h2><p>Connaissance de la région, conduite souple, discrétion et disponibilité : une présence attentive, sans jamais être intrusive.</p><Link prefetch={false} className="text-link dark" href="/a-propos">En savoir plus <i>↗</i></Link></div></section>
